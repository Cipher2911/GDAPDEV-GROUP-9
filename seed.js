...
connectToMongo(async (err) => {
    ...
    try {
        ...
        const users = await User.insertMany([
            { username: "felix", name: "Felix Kjellberg", dlsu_id: "12423456", college: "College of Science", email: "pewds@dlsu.edu.ph", avatar: "FK" },
            { username: "mark", name: "Mark Fishbach", dlsu_id: "12498765", college: "Gokongwei College of Engineering", email: "markiplier@dlsu.edu.ph", avatar: "MF" },
            { username: "hermione", name: "Hermione Granger", dlsu_id: "12400001", college: "College of Business", email: "h.granger@dlsu.edu.ph", avatar: "HG" },
            { username: "marques", name: "Marques Brownlee", dlsu_id: "12454433", college: "College of Computer Studies", email: "mkbhd@dlsu.edu.ph", avatar: "MB" },
            { username: "linus", name: "Linus Sebastian", dlsu_id: "12447788", college: "College of Computer Studies", email: "linus@dlsu.edu.ph", avatar: "LS" }
        ]);
        ...
        // 3. Insert Reservations (Converted from labData and availableSlots)
